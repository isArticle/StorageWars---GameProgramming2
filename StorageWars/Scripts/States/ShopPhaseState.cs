...
namespace StorageWars
{
    ...
    {
        public ShopPhaseState(Game1 game) : base(game) // Sahne açıldığında ShopManager'a o tur için yeni yetenekleri dükkana dizmesi emrini verir
        { 
            _game.Window.Title = "SHOP | SPACE: Next Round";
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch) { _game.UIManager.DrawShopPhase(spriteBatch, _game.Player1, _game.Player2, _game.ShopManager); } // Çizimi delege eder
    }
}