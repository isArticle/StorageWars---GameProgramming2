...
namespace StorageWars
{
    public static class AssetManager
    {
        ...
        public static void DrawTextBottomCenter(SpriteBatch sb, string text, Vector2 position, Color color) //Normal Metin Çizici
        {
        ...
        public static Texture2D GetItemTexture(string textureName) // İstenen eşyanın görselini sözlükten bulur, yoksa Content'ten okur ve RAM'e kaydeder
        {
